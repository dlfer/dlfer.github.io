...
draw ( circle (O,rad), thickpen + Indigo );
...
draw (V1 -- V2 -- V3 -- cycle, thickpen + Indigo );

draw ( circle (O,0.5*rad), thickpen + Indigo );
...
lotuschars( O, rotate(90-0* 360/16) * one, 0.94 , new string[]
// { "अं", "आं", "इं", "ईं", "उं", "ऊं", "ऋं", "ॠं", "ळूं", "लूं", "एं", "ऐं", "ओं", "औं", "अं:", "अः" }, Crimson
   { "अं", "आं", "इं", "ईं", "उं", "ऊं", "ऋं", "ॠं", "ऌं", "ॡं", "एं", "ऐं", "ओं", "औं", "अं:", "अः" }, Crimson
);
